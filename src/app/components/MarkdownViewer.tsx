          ...
          components={{
            code({ node, inline, className, children, ...props }: any) {
              ...
              return (
                <code
                  {...props}
                  className={`${className} bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded text-sm font-mono text-pink-600 dark:text-pink-400`}
                >
                  {children}
                </code>
              );
            ...
            h1: ({ node, ...props }) => (
              <h1
                className="text-3xl font-bold mt-8 mb-4 pb-2 border-b border-zinc-200 dark:border-zinc-800"
                {...props}
              />
            ),
            h2: ({ node, ...props }) => (
            ...
            img: ({ node, ...props }) => (
              <img
                className="rounded-lg max-w-full h-auto my-4 border border-zinc-200 dark:border-zinc-800"
                {...props}
              />
            ),
            table: ({ node, ...props }) => (
            ...
            td: ({ node, ...props }) => (
              <td
                className="px-3 py-2 border-t border-zinc-200 dark:border-zinc-800 text-sm"
                {...props}
              />
            ),
            hr: ({ node, ...props }) => (
